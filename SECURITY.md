...
ListinoDiff is a static client-side demo. Uploaded CSV files are processed in the browser and are not sent to an application backend.

## Current protections

- CSV-controlled SKU and product values are rendered through DOM text nodes rather than HTML injection sinks.
...
- Price parsing rejects non-finite values.
...
This project is a portfolio demo, not a security-audited procurement system.
